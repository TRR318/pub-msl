...
if __name__ == "__main__":
    ...
    data_bupa = pd.read_csv(
        "experiments/data/liver_disorders/bupa.data",
        sep=",",
        header=None,
    ...
    costs_bupa = pd.read_csv(
        "experiments/data/liver_disorders/bupa-liver.expense",
        sep=r"\t+",
        header=None,
        index_col=0,
        engine="python",
    ...
    for seed in range(0, 100):
        ...
        for i in range(0, num_features):
            ...
            y_prob_dt, used_features = limited_feature_predict(
                dt, X_test, max_features=i
            )
