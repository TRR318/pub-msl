...
from miss.riskslim.loss_functions.ce_loss import softmax, cross_entropy
...
def setup_loss_functions(data, coef_set, L0_max=None, loss_computation=None, w_pos=1.0, is_multiclass=False):
    ...
    if final_loss_computation == 'weighted':
        ...
        from miss.riskslim.loss_functions.log_loss_weighted import \
            log_loss_value, \
        ...
        from miss.riskslim.loss_functions.log_loss import \
            log_loss_value, \
            log_loss_value_and_slope, \
            log_loss_value_from_scores
        ...
        from miss.riskslim.loss_functions.fast_log_loss import \
            log_loss_value, \
            log_loss_value_and_slope, \
            log_loss_value_from_scores
        ...
        from miss.riskslim.loss_functions.lookup_log_loss import \
        ...
        from miss.riskslim.loss_functions.ce_loss import ce_loss_value, ce_loss_value_and_slope, ce_loss_value_from_scores
