...
from miss.riskslim.coefficient_set import MCCoefficientSet, CoefficientSet
from miss.riskslim.defaults import INTERCEPT_NAME
from miss.riskslim.lattice_cpa import run_lattice_cpa
from miss.riskslim.loss_functions.ce_loss import softmax
from miss.riskslim.utils import check_data
...
class RiskSLIMClassifier(RiskSLIMBase):
    ...
    def fit(self, x: pd.DataFrame, y: pd.DataFrame):
        ...
        model_info, mip_info, lcpa_info = run_lattice_cpa(
...
class MISSClassifier(RiskSLIMBase, ClassifierMixin, BaseEstimator):
    """
    ...
    def __init__(self, mc_l0_min, mc_l0_max, l0_min=0, l0_max=0, c0_value=0, mc_c0_value=1e-6, oversampler=None,
        ...
        super().__init__(l0_min=l0_min, l0_max=l0_max, mc_l0_min=mc_l0_min, mc_l0_max=mc_l0_max,
                         ...
                         c0_value=c0_value, polishing_stop_gap=0.4,
                         max_coefficient=max_coefficient,
                         max_intercept=max_intercept, **kwargs)
    ...
    def __len__(self):
        return np.count_nonzero((self._rho.reshape(len(self._model[1]["variable_names"]), -1)==0).all(axis=1) != True) -1
